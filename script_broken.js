        ...
        <div class="executive-dashboard">
            ...
            <div class="strategic-recommendations">
                ...
                <div class="recommendation-item">
                    ...
                    <div class="recommendation-content">
                        <h4>Geo‑Diversification Strategy</h4>
                        <p>Shift 5% of new commitments to Latin America & Caribbean to offset high concentration in SSA & South Asia. This will reduce portfolio risk and capture emerging opportunities in LAC markets.</p>
                    </div>
                </div>
                ...
                <div class="recommendation-item">
                    ...
                    <div class="recommendation-content">
                        <h4>Speed‑Up Disbursement Efficiency</h4>
                        <p>Implement a rapid‑disbursement track for high‑priority health and climate projects; target >80% disbursement efficiency. Current rate at 70.2% indicates significant bottlenecks.</p>
                    </div>
                </div>
                ...
                <div class="recommendation-item">
                    ...
                    <div class="recommendation-content">
                        <h4>Partner Capacity Strengthening</h4>
                        <p>Fund $200M in training for co‑financiers in West Africa & Central Asia to improve compliance and attract more trust‑fund co‑financing partnerships.</p>
                    </div>
                </div>
                ...
                <div class="recommendation-item">
                    ...
                    <div class="recommendation-content">
                        <h4>Results‑Driven Financing</h4>
                        <p>Introduce results‑linked supplemental grants for education projects that deliver above‑threshold enrollment gains to incentivize performance outcomes.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="dashboard-metrics-grid">
                <div class="metric-card">
                    ...
                    <div class="metric-value">$47.3B</div>
                ...
                <div class="metric-card">
                    <div class="metric-header">
                        ...
                        <div class="metric-trend positive">+67</div>
                    </div>
                    <div class="metric-value">929</div>
                ...
                <div class="matrix-grid">
                    <div class="matrix-quadrant high-impact-high-performance">
                        ...
                        <ul class="quadrant-items">
                            <li>Education sector (High enrollment gains)</li>
                            <li>Health infrastructure (Strong outcomes)</li>
                            <li>Climate adaptation (High co-benefits)</li>
                        </ul>
                    </div>
                    ...
                    <div class="matrix-quadrant high-impact-low-performance">
                        ...
                        <ul class="quadrant-items">
                            <li>Agriculture projects (Implementation delays)</li>
                            <li>Urban development (Cost overruns)</li>
                            <li>Transport infrastructure (Slow disbursement)</li>
                        </ul>
                    </div>
...
function initializeExecutiveCharts(dashboardId) {
    ...
    if (sectorCtx) {
        new Chart(sectorCtx, {
            type: 'doughnut',
            data: {
                labels: ['Health', 'Education', 'Infrastructure', 'Agriculture', 'Climate', 'Other'],
                datasets: [{
                    data: [18.5, 22.1, 28.3, 12.7, 15.2, 3.2],
                    backgroundColor: [
    ...
    if (regionalCtx) {
        new Chart(regionalCtx, {
            type: 'bar',
            data: {
                labels: ['Sub-Saharan Africa', 'South Asia', 'East Asia & Pacific', 'Latin America', 'MENA', 'Europe & Central Asia'],
                datasets: [{
                    label: 'Portfolio Value ($B)',
                    data: [16.8, 12.4, 8.9, 4.2, 3.1, 1.9],
...
function exportChartData(chartType) {
    ...
    // In a real implementation, this would export chart data
